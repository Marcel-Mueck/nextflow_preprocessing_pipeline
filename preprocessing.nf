...
process create_parquet_variant_ids {
    ...
    shell:
    '''
    deeprvat_preprocess add-variant-ids  "variants_no_id.tsv.gz" "variants.parquet" "duplicates.parquet"
    '''
}
...
process add_variant_ids {
    ...
    shell:
    '''
    deeprvat_preprocess add-variant-ids  "variants_no_id.tsv.gz" "variants.tsv.gz" "duplicates.tsv"
    '''
}
...
workflow  {
    ...
    def pathFile = 'example/vcf_files_test.txt'
